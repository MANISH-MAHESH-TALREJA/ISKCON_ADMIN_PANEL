<?php 
    ...
    $page_title="View Diets";

    date_default_timezone_set("Asia/Kolkata");

    require("includes/connection.php");

    $diet_id=trim($_GET['diet_id']);

    $sql="SELECT * FROM tbl_diets WHERE tbl_diets.`id`='$diet_id' ORDER BY tbl_diets.`diet_title` DESC";
    ...
    $url2='diet://diet_plan_app/view_diet.php?diet_id='.$diet_id;
...
<div class="container">
    ...
    <h3>Diet Name: <span style="font-weight:500;color:#424242;font-size:16px"><?=$row['diet_title']?></span></h3>
    <!--<img class="add_images" src="banner.jpg" alt="banner" />-->
    <p style="font-weight:500">If you already have the install app then View diet details</P>
    <button class="joinBtn" onclick="window.open('<?=$url2?>','_blank')">View diet details!</button>
