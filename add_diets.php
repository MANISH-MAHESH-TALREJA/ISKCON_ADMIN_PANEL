              ...
              <div class="section">
                <div class="section-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="diet_title" id="diet_title" value="" class="form-control" required>
                    </div>
                  </div>
          <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <textarea name="diet_info" id="diet_info" class="form-control"></textarea>
                      <script>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="fileupload_block">
                        <input type="file" name="diet_image" id="fileupload" required="required">
                         <div class="fileupload_img"><img id="diet_image" type="image" src="assets/images/portrait.jpg" alt="image" style="width: 140px;height: 90px" /></div>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
