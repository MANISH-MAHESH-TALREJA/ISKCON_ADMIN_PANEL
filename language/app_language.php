<?php
	...
	$app_lang['account_deactive']="Sorry! Your account is deactivated or deleted.";
	...
	// for email exist
	$app_lang['no_data_found_msg']="Sorry! no data found";
	...
	// for comment delete
	$app_lang['delete_bim_cal']="Bim calculator is deleted...";
	...
	$app_lang['not_recent_video']="Not store recent video.";

	$app_lang['please_try_video']="please try again later";
