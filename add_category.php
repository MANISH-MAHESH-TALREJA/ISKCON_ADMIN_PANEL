          ...
          <div class="section-body">
            ...
            <div class="form-group">
             <label class="col-md-3 control-label">Select Image :-
               <p class="control-label-help">(Recommended Resolution:200 x 400 Image)</p></label>
               <div class="col-md-6">
                 <div class="fileupload_block">
                   <input type="file" name="category_image" value="" id="fileupload" <?=!isset($row['category_image']) ? 'required="required"' : ''?>>
                   <div class="fileupload_img featured_image">
                     ...
                     <?php } else {
                       ?>
                       <img id="ImdID" type="image" src="assets/images/landscape.jpg" alt="Featured image" style="width: 100px;height: 100px;"/>
                       <?php
                     } ?>
                   </div>
                 </div>
