                  ...
                  <div class="wall_image_title">
                    ...
                    <ul>                
                     ...
                     <?php if($row['show_on_home']!='0'){?>
                      <li>
                        <a href="javascript:void(0)" class="toggle_btn_a" data-id="<?php echo $row['cid'];?>" data-action="disable" data-column="show_on_home" data-toggle="tooltip" data-tooltip="Show Home" data-table="tbl_category">
                          <i class="fa fa-home" style="color: green"></i>
                        </a>
                      </li>
                    <?php }else{?>
                     <li>
                      <a href="javascript:void(0)" class="toggle_btn_a" data-id="<?php echo $row['cid'];?>" data-action="enable" data-column="show_on_home" data-toggle="tooltip" data-tooltip="Set On Home" data-table="tbl_category"><i class="fa fa-home"></i>
                      </a>
                    </li>
                  <?php }?>
