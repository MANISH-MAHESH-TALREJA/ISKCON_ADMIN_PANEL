...
if(isset($_POST['submit']))
{
  ...
  $data = array(
   ...
   'api_video_order'  =>  $_POST['api_video_order'],
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="fileupload_block">
                       ...
                       <?php } else {?>
                         <div class="fileupload_img"><img type="image" id="app_logo" src="assets/images/add-image.png" alt="image" style="width: 90px;height: 90px;"/></div>
                       <?php }?>
                     </div>
                   </div>
                 </div>
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-12">
                <div class="form-group" id="#admob_banner_id">                              
                  ...
                  <p class="field_lable">Position of Ad:- <br/></p>
                  <div class="col-md-12"> 
  ...
  <form action="" name="settings_api" method="post" class="form form-horizontal" enctype="multipart/form-data">
    <div class="section">
      <div class="section-body">
       ...
       <div class="col-md-6">
        <label class="col-md-5 control-label">Video Post Order:-</label>
        <div class="col-md-7">
         <select name="api_video_order" id="api_video_order" class="select2">
           <option value="ASC" <?php if($settings_row['api_video_order']=='ASC'){?>selected<?php }?>>ASC</option>
           <option value="DESC" <?php if($settings_row['api_video_order']=='DESC'){?>selected<?php }?>>DESC</option>
         </select>
       </div>
     </div>
     <div class="col-md-6">
